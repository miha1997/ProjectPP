...
public class SimpleMethodVarDeclList extends MethodVarDeclList {

    private MethodVarDeclList MethodVarDeclList;
    private VarDecl VarDecl;

    public SimpleMethodVarDeclList (MethodVarDeclList MethodVarDeclList, VarDecl VarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("SimpleMethodVarDeclList(\n");
